...
public class CopyServiceTest {
    ...
    void shouldReturnCurrentlyBorrowedCopies() {
        ...
        Mockito.when(modelMapperMock.map(copy1, CopyDto.class))
                .thenReturn(new CopyDto(1L, currentDate, currentDate, currentDate.plusDays(30), currentDate, List.of()));

        Mockito.when(modelMapperMock.map(copy2, CopyDto.class))
                .thenReturn(new CopyDto(2L, currentDate, currentDate, currentDate.plusDays(30), currentDate, List.of()));
